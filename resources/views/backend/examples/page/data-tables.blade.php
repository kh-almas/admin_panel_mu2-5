    ...
    <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Datatables</h1>
                <p class="mb-0">Dozens of reusable components built to provide buttons, alerts, popovers, and more.</p>
            </div>
            <div>
                <a href="https://datatables.net/examples/api/multi_filter.html" class="btn btn-outline-gray"><i class="far fa-question-circle me-1"></i> Data Tables Docs</a>
            </div>
        </div>
    </div>
    <div class="card border-light shadow-sm">
        <div class="card-body">
            <div class="table-responsive">
                <table id="example" class="display table table-centered table-nowrap mb-0 rounded" style="width:100%">
