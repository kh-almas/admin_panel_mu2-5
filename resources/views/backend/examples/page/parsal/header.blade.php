    ...
    <div class="sidebar-inner px-4 pt-3">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse" role="list" id="library" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item <?php if(basename($_SERVER['PHP_SELF']) == 'images.php'){ echo 'active'; } ?>">
                        ...
                        <li class="nav-item <?php if(basename($_SERVER['PHP_SELF']) == 'videos.php'){ echo 'active'; } ?>">
            ...
            <li class="nav-item <?php if(basename($_SERVER['PHP_SELF']) == 'profile-settings.php'){ echo 'active'; } ?>">
            ...
            <li class="nav-item">
                ...
                <div class="multi-level collapse" role="list" id="Task" aria-expanded="false">
                    <ul class="flex-column nav">
                        <li class="nav-item <?php if(basename($_SERVER['PHP_SELF']) == 'images.php'){ echo 'active'; } ?>">
