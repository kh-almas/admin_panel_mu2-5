...
<!-- Primary Meta Tags -->
<title>Welcome to daytodays</title>
...
<!-- Fontawesome -->
<link type="text/css" href="{{asset('backend/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css')}}" rel="stylesheet">
...
<link rel="stylesheet" href="{{asset('backend/assets/playlist/playlist.css')}}">

<!-- date and date range picker -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/lightpick@1.3.4/css/lightpick.min.css">

<!-- choices -->
<link rel="stylesheet" href="{{ asset('backend/assets/vendor/choices/styles/choices.min.css') }}">
