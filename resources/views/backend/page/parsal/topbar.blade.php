<nav class="navbar <?php if(basename($_SERVER['PHP_SELF']) == 'play-video.php'){ echo 'd-none'; } ?> navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 pb-0">
    <div class="container-fluid px-0">
        <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
            <div class="d-flex align-items-center">
                <button  onclick="hidesidebartext()" id="sidebar-toggle" class="sidebar-toggle me-3 btn btn-icon-only btn-lg btn-circle d-none d-md-inline-block">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <a href="#" class="list-group-item list-group-item-action border-bottom border-light">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <!-- Avatar -->
                                        <img alt="Image placeholder" src="./backend/assets/img/team/profile-picture-3.jpg" class="user-avatar lg-avatar rounded-circle">
                                    </div>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="media d-flex align-items-center">
                            <img class="user-avatar md-avatar rounded-circle" alt="Image placeholder" src="{{ asset('storage/'.auth()->user()->profile_photo_path) }}">
                        </div>
                    </a>
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-0">
                        <a class="dropdown-item rounded-top fw-bold" href="{{ route('dashboard.profile.settings') }}"><span class="far fa-user-circle"></span>My Profile</a>
                        ...
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <button class="dropdown-item rounded-bottom fw-bold" type="submit"><span class="fas fa-sign-out-alt text-danger"></span>Sign Out</button>
                        </form>
                    </div>
                </li>
            </ul>
